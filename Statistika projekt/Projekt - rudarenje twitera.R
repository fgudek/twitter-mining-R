...
# build wordcloud 
wordcloud <- wordcloud2(data = textCorpus,demoFreq, size=0.8, minRotation = 0, maxRotation = 0, ellipticity = 0.6)
wordcloud
...
bing_word_counts %>%
  ...
  labs(title = "Sentiment tweetova o Americi tijekom US2020 izbora",
